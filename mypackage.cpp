...
// void print(Type1 text, string sep, string end){
//     cout << text << sep << end;
// }
...
void print(float number, string sep, string end){
...
string repeat(Type4 text, int count, string sep, string end){
    string result = "";
...
// string repeat(char text, int count, string sep, string end){
//     string result = "";
//     for (int x = 0; x < count; x++){
//         if (x < count - 1){
//             result += text + sep;
